...
//todo он нигде не используется, вроде, надо удалить, наверное.
...
int main(int argc, char *argv[]) {
	...
	//todo, it's your code further, I think that it's work, but for several reasons I used another earlier
	//add started
	int opt=0;
	//start, check key and count of children
